            ...
            <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <form action="<?php echo site_url('soal/insert') ?>" method="post" enctype="multipart/form-data" >
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kategori_id" id="kategori_id" class="form-control form-control-sm <?php echo form_error('kategori_id') ? 'is-invalid':'' ?>">
                                        ...
                                        <option value="<?php echo $key_kat; ?>"><?php echo $rec_kat; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="sub_kategori_id" id="sub_kategori_id" class="form-control form-control-sm <?php echo form_error('sub_kategori_id') ? 'is-invalid':'' ?>">
                                        ...
                                        <option value="<?php echo $key_subkat; ?>"><?php echo $rec_subkat; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    name="soal" rows="5" placeholder="Tulis Soal..."></textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control-file form-control-file-sm <?php echo form_error('gambar') ? 'is-invalid':'' ?>"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_active" id="is_active2" value="1" checked>
